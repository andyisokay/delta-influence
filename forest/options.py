...
def options():
    ...
    parser.add_argument('--dataset', default='CIFAR10', type=str, choices=['CIFAR10', 'CIFAR100', 'CIFAR10_Filtered', 'CIFAR10_Poisoned', 'CIFAR10_500_Removed', 'CIFAR10_Portion_Removed', 'Imagenette', 'ImageNet', 'ImageNet1k', 'MNIST', 'TinyImageNet'])
